...
/** @memo Set the name of a cookie
    ...
    @doc Change the name of a cookie that was created with \Ref{HTTP_CreateCookie} or retrieved with \Ref{HTTP_FindMatchingCookie}.
...
/** @memo Set the value of a cookie
    ...
    @doc  Change the value of a cookie that was created with \Ref{HTTP_CreateCookie} or retrieved with \Ref{HTTP_FindMatchingCookie}.
...
/** @memo Set the domain of a cookie
    ...
    @doc  Change the domain of a cookie that was created with \Ref{HTTP_CreateCookie} or retrieved with \Ref{HTTP_FindMatchingCookie}.
...
/** @memo Set the path of a cookie
    ...
    @doc  Change the path of a cookie that was created with \Ref{HTTP_CreateCookie} or retrieved with \Ref{HTTP_FindMatchingCookie}.
