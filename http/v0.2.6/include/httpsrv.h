...
typedef struct s_HTTPServerContext
{
	...
	int masterThreadActive; // getting it to compile
...
struct s_HTTPFrameWorkPageObject
{
	void*                     userData; /* Undefined for ow */
};
typedef struct s_HTTPFrameWorkPageObject HTTPFrameWorkPageObject;

struct s_HTTPFrameWorkAspTable
{
	void*                     userData; /* Undefined for now */
};
typedef struct s_HTTPFrameWorkAspTable HTTPFrameWorkAspTable;
